...
4. **GUI-Entwicklung mit Spring MVC**:
    ...
    - Weitere Informationen zur Erstellung der Views findest du [hier](documentations/views_documentation.md).
...
## [API Testing-Dokumentation](documentations/TESTING.md)
